...
Page({
  data: {
    ...
    uploadImagePath: '',
    currentMarkerId: 0,
    praiseSrc: '../../images/icon/bottom-unpraise.png',
    warningIconUrl: '',
    infoMessage: '',
    isUp: false,
    //中心指针，不随着地图拖动而移动
  ...
  bindSearchTap: function () {
    ...
    wx.redirectTo({
      url: '../searchMapLocation/searchMapLocation?scenario=' + this.data.scenario,
    })
  },
  ...
  onLoad: function (options) {
    ...
    that.updateCenterLocation(that.data.centerLatitude, that.data.centerLongitude);
...
/**
  ...
  confirmClick: function (res) {
    ...
    if(this.data.scenario == 'train'){
      wx.redirectTo({
        url: '../train/train?selectAddress=' + that.data.selectAddress + '&latitude=' + that.data.centerLatitude + '&longitude=' + that.data.centerLongitude,
      })
    } else if (this.data.scenario == 'activity'){
      wx.redirectTo({
        url: '../activity/activity?selectAddress=' + that.data.selectAddress + '&latitude=' + that.data.centerLatitude + '&longitude=' + that.data.centerLongitude,
      })
    }
  ...
  createMarker: function (dataList) {
    ...
    for (var key in markerList) {
      ...
      marker.height = 40;
      if (marker.image) {
        marker.iconPath = '../../images/icon/dog-select.png';
      } else {
        marker.iconPath = '../../images/icon/dog-yellow.png';
      }
    }
